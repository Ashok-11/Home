...
INDEXES: dict[str, list[IndexModel]] = {
    ...
    "budgets": [IndexModel([("month", ASCENDING), ("member", ASCENDING)], name="month_member", unique=True)],
    "allowances": [IndexModel([("month", ASCENDING), ("member", ASCENDING)], name="month_member", unique=True)],
    "categories": [IndexModel([("name", ASCENDING)], name="name", unique=True)],
    "aisles": [IndexModel([("name", ASCENDING)], name="name", unique=True)],
    "timings": [IndexModel([("order", ASCENDING)], name="order_asc")],
    "houses": [IndexModel([("is_default", ASCENDING)], name="is_default")],
    ...
    "menu_entries": [IndexModel([("date", ASCENDING), ("timing_order", ASCENDING)], name="date_timing")],
